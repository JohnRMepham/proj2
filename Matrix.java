public class Matrix {
    ...
    public static double[][] map_to_binary(String[][] matrix) {
        int columns = matrix.length;
    ...
    public static double[][] map_to_bipolar(String[][] matrix) {
        int columns = matrix.length;
        int rows = matrix[0].length;
        double[][] mapped = new double[rows][columns];
    ...
    public static String[][] map_to_zero_and_spaces(double[][] matrix) {
        int rows = matrix.length;
        int columns = matrix[0].length;
